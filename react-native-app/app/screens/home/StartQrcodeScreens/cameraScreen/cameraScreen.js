...
class cameraScreen extends Component {
    state = {
      ...
      _maybeRenderUrl = () => {
        ...
        return (
          <View style={styless.bottomBar}>
            <TouchableOpacity style={styless.url} onPress={this._handlePressUrl}>
              <Text numberOfLines={1} style={styless.urlText}>
                {this.state.lastScannedUrl}
              </Text>
            </TouchableOpacity>
            <TouchableOpacity
              ...
              <Text style={styless.cancelButtonText}>
                Cancel
              </Text>
            </TouchableOpacity>
          </View>
